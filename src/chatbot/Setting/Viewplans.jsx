...
// const stripePromise = loadStripe('pk_test_51QjO3HAkiLZQygvDSwucdMyDyPbxIHJBq2OUFL9cYV3OhWbxcIy3Zn84pjzC0r4CYvHQwvklMJmkxYFOLhGj1OBU00cL8KKeIN'); // Your publishable key
...
//           metadata: {
//             order_id: `ORD_${selectedPlan.id}_${Date.now()}`
//           }
//         }),
//       });
...
//           billing_details: {
//             name: 'Test User', // You can allow user to input this
//           },
//         },
//       });
...
//         onClose(); // Close payment form after success
//       }
//     } catch (error) {
...
//   return (
//     <form onSubmit={handleSubmit} className="text-start" style={{ maxWidth: 500, margin: 'auto' }}>
//       <h4 className="mb-3">Pay for {selectedPlan.plan_name}</h4>
//       <CardElement
//         options={{
//           style: {
//             base: {
...
//       </button>
//       <button className="btn btn-link mt-2" onClick={onClose} type="button">
//         Cancel
//       </button>
//     </form>
//   );
...
//   const fetchPlans = async () => {
//     try {
//       const response = await fetch(`https://netaai-backend-production.up.railway.app/api/plan/subscription-plans`);
//       const data = await response.json();
//       const filteredPlans = data.filter(plan => [5, 6, 7].includes(plan.id));
//       const sortedPlans = filteredPlans.sort((a, b) => a.id - b.id);
//       setPlans(sortedPlans);
